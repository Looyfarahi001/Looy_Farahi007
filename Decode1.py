# -*- coding=utf-8 -*-
# Copyright © Mhank BarBar (Looy Farahi001)
# Recode ? Silahkan
...
bm = '\x1b[96m'
about =     '''
                {}Creator           : {}Looy Farahi001
                {}About             : {}Encrypt And Decrypt Tool
                {}Version           : {}1.0 (beta)
                {}Special thanks to : {}Allah SWT and YOU
                {}Code name         : {}Tytyd:v
                {}Team              : {}FARAH HACK
                {}E-mail            : {}raminhayati007@gmail.com
                {}Github            : {}github.com/Looyfarahi001
                {}Telegram          : {}t.me/Farah_Hack
                {}Facebook          : {}Upss (Fb gua masih kena cp:v)
                {}Date              : {}16.49 02-07-2021
